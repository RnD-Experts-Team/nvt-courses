import{z as $e,g as et,o as d,w as tt,e,a as r,s as Me,t as s,n as Xe,F as u,i as h,v as Ie,ad as st,h as f,f as it,r as Ve,a2 as at,c as Ze,B as ot,W as lt}from"./app-_nO82cJ9.js";import{_ as dt}from"./AdminLayout.vue_vue_type_script_setup_true_lang-5jlDe1ml.js";import{_ as rt}from"./_plugin-vue_export-helper-DcXr-Qr8.js";import"./AppLayout.vue_vue_type_script_setup_true_lang-C6azjvrb.js";import"./Button.vue_vue_type_script_setup_true_lang-Cxl4gBbw.js";import"./index-x3NKxpPc.js";import"./index-DC0bq2kv.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-VuVqRoOp.js";import"./clock-piRtg6h5.js";const nt={name:"MonthlyKpiDashboard",components:{AdminLayout:dt},props:{kpiData:{type:Object,required:!0},filterData:{type:Object,required:!0},currentFilters:{type:Object,required:!0},lastUpdated:{type:String,required:!0}},setup(o){const t=Ve(!1),i=Ve(!1),l=Ve(!1),_=at({month:o.currentFilters.month,year:o.currentFilters.year,department_id:o.currentFilters.department_id||"",course_id:o.currentFilters.course_id||""}),Be=Ze(()=>[{label:"Dashboard",href:route("dashboard")},{label:"Reports",href:route("admin.reports.index")},{label:"Monthly KPI Dashboard",href:null}]),Ue=async()=>{try{l.value=!0;const n=Re(),c=window.open("","screenshot","width=1200,height=800");if(!c)throw new Error("Popup blocked. Please allow popups for this site.");c.document.write(n),c.document.close(),await new Promise(b=>setTimeout(b,1e3));const g=c.document.createElement("script");g.src="https://html2canvas.hertzen.com/dist/html2canvas.min.js",c.document.head.appendChild(g),await new Promise(b=>{g.onload=b}),await new Promise(b=>setTimeout(b,500));const v=await c.html2canvas(c.document.body,{backgroundColor:"#ffffff",scale:1.5,useCORS:!0,allowTaint:!0,width:c.document.body.scrollWidth,height:c.document.body.scrollHeight}),m=document.createElement("a");m.download=`KPI_Report_${_.month}_${_.year}_${new Date().toISOString().split("T")[0]}.png`,m.href=v.toDataURL("image/png",.9),document.body.appendChild(m),m.click(),document.body.removeChild(m),c.close(),console.log("✅ Screenshot generated successfully!"),alert("📸 Screenshot downloaded successfully!")}catch(n){console.error("❌ Screenshot failed:",n),alert(`Screenshot failed: ${n.message}
